...
public class swipeika : MonoBehaviour
{
    ...
    public swipeika.SwipeDirection swipeDir;
    ...
    private Scene_IkaSelection ikaSelectionComp;
    
    // Methods
    private void Start()
    {
        this.ikaSelectionComp = this.ikaSelection.GetComponent<Scene_IkaSelection>();
        this.instructionalPanel.SetActive(value:  false);
        this.touchBool = false;
        swipeika.touchBoolIka = false;
        this.imageNew.SetActive(value:  false);
        this.nameCounter = 0;
        UnityEngine.PlayerPrefs.SetInt(key:  "PlayerCharacter", value:  0);
        swipeika.instance = this;
    ...
    private System.Collections.IEnumerator AnimationAtStart()
    {
        .<>1__state = 0;
        .<>4__this = this;
        return (System.Collections.IEnumerator)new swipeika.<AnimationAtStart>d__26();
    }
    private System.Collections.IEnumerator CharacterStatus()
    {
        .<>1__state = 0;
        .<>4__this = this;
        return (System.Collections.IEnumerator)new swipeika.<CharacterStatus>d__27();
    }
    private void Update()
    {
        float val_13;
        ...
        float val_15;
        float val_16;
        if(swipeika.touchBoolIka == false)
        {
                return;
        }
        ...
        if((UnityEngine.Input.GetMouseButtonDown(button:  0)) != false)
        {
            ...
            this.startPos = val_3;
            mem[1152921528833805212] = val_3.y;
            this.touchBool = true;
        }
        ...
        if(((UnityEngine.Input.GetMouseButton(button:  0)) != false) && (this.touchBool != false))
        {
            ...
            this.endPos = val_6;
            mem[1152921528833805220] = val_6.y;
            ...
            this.diff = val_7;
            mem[1152921528833805228] = val_7.y;
        ...
        this.diff = val_10;
        mem[1152921528833805228] = val_10.y;
        this.endPos = val_10;
        mem[1152921528833805220] = val_10.y;
        this.startPos = val_10;
        mem[1152921528833805212] = val_10.y;
    ...
    {
        .<>1__state = 0;
        return (System.Collections.IEnumerator)new swipeika.<DelayTouch>d__29();
    }
    private void FindSwipeDirection()
    {
        ...
        this.ikaSelectionComp.rightSwipe();
        int val_13 = this.nameCounter;
        val_13 = val_13 - 1;
        this.nameCounter = (val_13 >= 0) ? (val_13) : 13;
        if(this.ikaSelectionComp == null)
        {
                val_13 = this.nameCounter;
        }
        
        UnityEngine.Color val_4 = this.ikaSelectionComp.testimages[(long)val_13].GetComponent<UnityEngine.UI.Image>().color;
        if(val_4.r != 1f)
        {
            goto label_11;
        }
        ...
        this.ikaSelectionComp.leftSwipe();
        this.nameCounter = ((this.nameCounter + 1) >= 14) ? 0 : (this.nameCounter + 1);
        if(this.ikaSelectionComp == null)
        {
                val_15 = this.nameCounter;
        }
        
        UnityEngine.Color val_9 = this.ikaSelectionComp.testimages[(long)val_15].GetComponent<UnityEngine.UI.Image>().color;
        if(val_9.r != 1f)
        {
            goto label_26;
        }
    ...
    public void okClick()
    {
        ...
        UnityEngine.PlayerPrefs.SetString(key:  "tako", value:  "no");
        ...
        val_5 = null;
        val_5 = null;
        StoryPanelScript.keyForStory = "Ika_Start";
        goto label_13;
    }
    private System.Collections.IEnumerator LoadStoryPanels()
    {
        .<>1__state = 0;
        return (System.Collections.IEnumerator)new swipeika.<LoadStoryPanels>d__33();
    }
    private System.Collections.IEnumerator LoadStageSelect()
    {
        .<>1__state = 0;
        return (System.Collections.IEnumerator)new swipeika.<LoadStageSelect>d__34();
    }
    private System.Collections.IEnumerator FillMeter()
    {
        .<>1__state = 0;
        return (System.Collections.IEnumerator)new swipeika.<FillMeter>d__35();
    }
    private void SetIkaName()
    {
