using UnityEngine;
public sealed class Model_Events.OnStunBreakDelegate : MulticastDelegate
{
    // Methods
    public Model_Events.OnStunBreakDelegate(object object, IntPtr method)
    {
        mem[1152921529269334912] = object;
        mem[1152921529269334920] = method;
        mem[1152921529269334896] = method;
    }
    public virtual void Invoke(InkWars.Model.Player playerId, float revengeSuperLevel, InkWars.Model.BubbleTypes loadedBubbble, InkWars.Model.BubbleTypes spareBubble)
    {
        var val_10;
        var val_11;
        var val_12;
    ...
    public virtual System.IAsyncResult BeginInvoke(InkWars.Model.Player playerId, float revengeSuperLevel, InkWars.Model.BubbleTypes loadedBubbble, InkWars.Model.BubbleTypes spareBubble, System.AsyncCallback callback, object object)
    {
