...
public class WhirlpoolScript : MonoBehaviour
{
    ...
    public void Start()
    {
        ...
        WhirlpoolScript.isForDefense = false;
        ...
        WhirlpoolScript.whirlpoolFlag = false;
        this.flag = true;
    ...
    {
        if(WhirlpoolScript.whirlpoolFlag == false)
        {
                return;
        }
    ...
    private System.Collections.IEnumerator whirlpool()
    {
        .<>1__state = 0;
        .<>4__this = this;
        return (System.Collections.IEnumerator)new WhirlpoolScript.<whirlpool>d__8();
    }
    public WhirlpoolScript()
    {
