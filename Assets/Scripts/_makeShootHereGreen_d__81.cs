using UnityEngine;
private sealed class DemoManager.<makeShootHereGreen>d__81 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public DemoManager.<makeShootHereGreen>d__81(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        this.<>4__this.shootHere.GetComponent<UnityEngine.UI.Image>().color = new UnityEngine.Color() {r = val_4.r, g = val_4.g, b = val_4.b, a = val_4.a};
        UnityEngine.Color val_8 = UnityEngine.Color.op_Implicit(v:  new UnityEngine.Vector4() {x = 0f, y = 0f, z = 0f, w = 0f});
        this.<>4__this.shootHere.transform.GetChild(index:  0).GetComponent<UnityEngine.UI.Image>().color = new UnityEngine.Color() {r = val_8.r, g = val_8.g, b = val_8.b, a = val_8.a};
        val_11 = 1;
