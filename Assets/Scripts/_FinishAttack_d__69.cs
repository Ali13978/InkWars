using UnityEngine;
private sealed class LineControllerAI.<FinishAttack>d__69 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public LineControllerAI.<FinishAttack>d__69(int <>1__state)
    {
