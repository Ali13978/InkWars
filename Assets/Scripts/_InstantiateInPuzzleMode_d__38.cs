using UnityEngine;
private sealed class ballSwipeScript.<InstantiateInPuzzleMode>d__38 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public ballSwipeScript.<InstantiateInPuzzleMode>d__38(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        this.<>4__this.puzzleBallHolder.gameObject.GetComponent<UnityEngine.Animator>().Play(stateName:  this.<>4__this + 136.ToString()(this.<>4__this + 136.ToString()) + "Balls", layer:  0, normalizedTime:  0f);
