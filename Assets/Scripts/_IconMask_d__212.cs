using UnityEngine;
private sealed class LineController.<IconMask>d__212 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public LineController.<IconMask>d__212(int <>1__state)
    {
