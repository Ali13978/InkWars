...
namespace Twitter
{
    public sealed class TwitterCallback : MulticastDelegate
    {
        // Methods
        public TwitterCallback(object object, IntPtr method)
        {
            mem[1152921529167900352] = object;
            mem[1152921529167900360] = method;
            mem[1152921529167900336] = method;
        }
        public virtual void Invoke(bool success, string response)
        {
            var val_16;
            var val_17;
            var val_18;
        ...
        public virtual System.IAsyncResult BeginInvoke(bool success, string response, System.AsyncCallback callback, object object)
        {
            bool val_1 = success;
