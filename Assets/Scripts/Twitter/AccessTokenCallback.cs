...
namespace Twitter
{
    public sealed class AccessTokenCallback : MulticastDelegate
    {
        // Methods
        public AccessTokenCallback(object object, IntPtr method)
        {
            mem[1152921529152154496] = object;
            mem[1152921529152154504] = method;
            mem[1152921529152154480] = method;
        }
        public virtual void Invoke(bool success, Twitter.AccessTokenResponse response)
        {
            var val_16;
            var val_17;
            var val_18;
            ...
            Twitter.AccessTokenResponse val_4 = val_18 + 296;
            label_39:
            label_22:
            bool val_5 = success;
            goto label_41;
        ...
        public virtual System.IAsyncResult BeginInvoke(bool success, Twitter.AccessTokenResponse response, System.AsyncCallback callback, object object)
        {
            bool val_1 = success;
