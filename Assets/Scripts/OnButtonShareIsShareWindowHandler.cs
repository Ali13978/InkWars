using UnityEngine;
[Serializable]
public sealed class VSSHARE.OnButtonShareIsShareWindowHandler : MulticastDelegate
{
    // Methods
    public VSSHARE.OnButtonShareIsShareWindowHandler(object object, IntPtr method)
    {
        mem[1152921529140568400] = object;
        mem[1152921529140568408] = method;
        mem[1152921529140568384] = method;
    }
    public virtual void Invoke()
    {
        ...
        if((((X23 + 0) + 32 + 32 + 8.TargetType) & 1) == 0)
        {
            goto label_21;
        }
        ...
        System.Type val_5 = X21.TargetType;
        if((X21 & 1) == 0)
        {
            goto label_37;
        }
