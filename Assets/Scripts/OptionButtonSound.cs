using UnityEngine;
public class OptionButtonSound : OptionButton
{
    // Methods
    protected override float GetBindingDataValue()
    {
        ...
        {
                val_7 = 0;
            bool val_1 = DeviceBasedData.enableSFX;
    ...
    protected override void SetBindingDataValue(float value)
    {
        ...
        DataStructs.UserDataDictionary.Settings.SoundEnabled = new CodeStage.AntiCheat.ObscuredTypes.ObscuredBool() {currentCryptoKey = val_2.currentCryptoKey, hiddenValue = val_2.hiddenValue, fakeValue = val_2.fakeValue & 4294967295, fakeValueChanged = val_2.fakeValue & 4294967295, inited = val_2.fakeValue & 4294967295};
    }
    public OptionButtonSound()
    {
