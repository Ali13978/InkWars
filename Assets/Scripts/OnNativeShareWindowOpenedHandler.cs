using UnityEngine;
[Serializable]
public sealed class VSSHARE.OnNativeShareWindowOpenedHandler : MulticastDelegate
{
    // Methods
    public VSSHARE.OnNativeShareWindowOpenedHandler(object object, IntPtr method)
    {
        mem[1152921529141644624] = object;
        mem[1152921529141644632] = method;
        mem[1152921529141644608] = method;
    }
