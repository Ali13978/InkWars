using UnityEngine;
public sealed class Model_Events.OnBeforePostMatchDelegate : MulticastDelegate
{
    // Methods
    public Model_Events.OnBeforePostMatchDelegate(object object, IntPtr method)
    {
        mem[1152921529272825728] = object;
        mem[1152921529272825736] = method;
        mem[1152921529272825712] = method;
    }
