using UnityEngine;
private sealed class PostDisconnectionBehaviour.<LoadPlayerAvatar>d__12 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    public PostDisconnectionBehaviour <>4__this;
    ...
    // Methods
    public PostDisconnectionBehaviour.<LoadPlayerAvatar>d__12(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        val_4 = this._image;
        val_4.sprite = this._cl.LoadAvatar_Main();
        label_1:
        val_7 = 0;
        return (bool)val_7;
        label_8:
