using UnityEngine;
public sealed class Model_Events.OnInkEmUpShotDelegate : MulticastDelegate
{
    // Methods
    public Model_Events.OnInkEmUpShotDelegate(object object, IntPtr method)
    {
        mem[1152921529268788608] = object;
        mem[1152921529268788616] = method;
        mem[1152921529268788592] = method;
    }
    public virtual void Invoke(InkWars.Model.Player playerId, float timeRemaining)
    {
        var val_10;
        var val_11;
        var val_12;
    ...
    public virtual System.IAsyncResult BeginInvoke(InkWars.Model.Player playerId, float timeRemaining, System.AsyncCallback callback, object object)
    {
