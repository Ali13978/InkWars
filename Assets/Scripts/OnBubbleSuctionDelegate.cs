using UnityEngine;
public sealed class Model_Events.OnBubbleSuctionDelegate : MulticastDelegate
{
    // Methods
    public Model_Events.OnBubbleSuctionDelegate(object object, IntPtr method)
    {
        mem[1152921529266513280] = object;
        mem[1152921529266513288] = method;
        mem[1152921529266513264] = method;
    }
    public virtual void Invoke(InkWars.Model.Player playerId, int ringID, int ringIndex, int amount)
    {
        Model_Events.OnBubbleSuctionDelegate val_10;
        var val_11;
        var val_12;
        var val_13;
        var val_14;
        ...
        label_37:
        var val_13 = val_7;
        val_13 = val_13 + ringID;
        val_12 = val_12 + val_13;
        int val_3 = val_12 + 296;
        label_39:
        val_14 = mem[(((X24 + X25 + 72) + (((X24 + 176 + 8) + 16) + ringID)) + 296) + 8];
        val_14 = (((X24 + X25 + 72) + (((X24 + 176 + 8) + 16) + ringID)) + 296) + 8;
        goto label_41;
        label_19:
        var val_14 = val_9;
    ...
    public virtual System.IAsyncResult BeginInvoke(InkWars.Model.Player playerId, int ringID, int ringIndex, int amount, System.AsyncCallback callback, object object)
    {
