using UnityEngine;
private sealed class TargetBallCPU.<BridgeThroughInnerRing>d__19 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public TargetBallCPU.<BridgeThroughInnerRing>d__19(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        val_46 = this.innerRingBalls[(long)val_46];
        if(val_46 == 0)
        {
            goto label_14;
        }
        
        val_46 = this.innerRingBalls[this.<j>5__4].gameObject;
        ...
        val_46 = this.innerRingBalls[(long)9 - (this.<j>5__4)];
        if(val_46 == 0)
        {
            goto label_34;
        }
        
        val_46 = this.innerRingBalls[(long)9 - (this.<j>5__4)].gameObject;
        ...
        label_21:
        val_46 = this.innerRingBalls[this.<j>5__4];
        if(val_46 == 0)
        {
            goto label_47;
        }
        ...
        UnityEngine.Vector3 val_22 = this.innerRingBalls[this.<j>5__4].gameObject.transform.position;
        val_48 = val_22.z;
        ...
        UnityEngine.Vector3 val_38 = this.innerRingBalls[(long)9 - (this.<j>5__4)].gameObject.transform.position;
        val_48 = val_38.z;
