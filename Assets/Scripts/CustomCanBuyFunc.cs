using UnityEngine;
public sealed class SoftCurrencyBuyButton.CustomCanBuyFunc : MulticastDelegate
{
    // Methods
    public SoftCurrencyBuyButton.CustomCanBuyFunc(object object, IntPtr method)
    {
        mem[1152921529030812560] = object;
        mem[1152921529030812568] = method;
        mem[1152921529030812544] = method;
    }
    public virtual bool Invoke()
    {
        ...
        System.Type val_2 = (X23 + 0) + 32 + 32 + 8.TargetType;
        if((((X23 + 0) + 32 + 32 + 8) & 1) == 0)
        {
            goto label_10;
        }
        ...
        val_9 = val_9 + 8;
        label_22:
        if((((X23 + 0) + 32 + 32 + 176 + 8) + -8) == ((X23 + 0) + 32 + 32 + 8.TargetType))
        {
            goto label_21;
        }
        ...
        System.Type val_4 = X21.TargetType;
        if((X21 & 1) == 0)
        {
            goto label_37;
        }
