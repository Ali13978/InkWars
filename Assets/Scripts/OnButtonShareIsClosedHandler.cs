using UnityEngine;
[Serializable]
public sealed class VSSHARE.OnButtonShareIsClosedHandler : MulticastDelegate
{
    // Methods
    public VSSHARE.OnButtonShareIsClosedHandler(object object, IntPtr method)
    {
        mem[1152921529139541328] = object;
        mem[1152921529139541336] = method;
        mem[1152921529139541312] = method;
    }
