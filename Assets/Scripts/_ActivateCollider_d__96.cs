using UnityEngine;
private sealed class LineControllerP2.<ActivateCollider>d__96 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public LineControllerP2.<ActivateCollider>d__96(int <>1__state)
    {
