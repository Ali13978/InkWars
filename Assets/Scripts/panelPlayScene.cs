using UnityEngine;
public class panelPlayScene : MonoBehaviour
{
    // Fields
    ...
    public panelPlayScene.SwipeDirection swipeDir;
    public static panelPlayScene instance;
    
    // Methods
    private void Start()
    {
        panelPlayScene.instance = this;
    }
    private void Update()
    {
        float val_11;
        ...
        if((UnityEngine.Input.GetMouseButtonDown(button:  0)) != false)
        {
            ...
            this.startPos = val_3;
            mem[1152921528725143724] = val_3.y;
        }
        ...
        if((UnityEngine.Input.GetMouseButton(button:  0)) != false)
        {
            ...
            this.endPos = val_6;
            mem[1152921528725143732] = val_6.y;
            ...
            this.diff = val_7;
            mem[1152921528725143740] = val_7.y;
        ...
        this.diff = val_10;
        mem[1152921528725143740] = val_10.y;
        this.endPos = val_10;
        mem[1152921528725143732] = val_10.y;
        this.startPos = val_10;
        mem[1152921528725143724] = val_10.y;
    ...
    private void FindSwipeDirection()
    {
        ...
        else
        {
                if((val_5 < 0) && (val_5 < 0))
        {
                UnityEngine.GameObject.FindWithTag(tag:  "instructionGameplay").GetComponent<playSceneCanvas>().nextButton();
            val_6 = 1;
        }
        else
        {
