using UnityEngine;
public sealed class ExpressShellPurchaseCanvas.OnShellsUpdatedDelegate : MulticastDelegate
{
    // Methods
    public ExpressShellPurchaseCanvas.OnShellsUpdatedDelegate(object object, IntPtr method)
    {
        mem[1152921529020075824] = object;
        mem[1152921529020075832] = method;
        mem[1152921529020075808] = method;
    }
    public virtual void Invoke(int _shells)
    {
        var val_10;
        var val_11;
        var val_12;
    ...
    public virtual System.IAsyncResult BeginInvoke(int _shells, System.AsyncCallback callback, object object)
    {
