using UnityEngine;
public sealed class Model_Events.ControllerNetworkMessageDelegate : MulticastDelegate
{
    // Methods
    public Model_Events.ControllerNetworkMessageDelegate(object object, IntPtr method)
    {
        mem[1152921529271683968] = object;
        mem[1152921529271683976] = method;
        mem[1152921529271683952] = method;
    }
    public virtual void Invoke(InkWars.Model.Controller_Network_Message message)
    {
        var val_10;
        var val_11;
        var val_12;
    ...
    public virtual System.IAsyncResult BeginInvoke(InkWars.Model.Controller_Network_Message message, System.AsyncCallback callback, object object)
    {
