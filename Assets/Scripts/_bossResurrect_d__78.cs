using UnityEngine;
private sealed class LineControllerAI.<bossResurrect>d__78 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public LineControllerAI.<bossResurrect>d__78(int <>1__state)
    {
