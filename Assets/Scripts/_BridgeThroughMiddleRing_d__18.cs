using UnityEngine;
private sealed class TargetBallCPU.<BridgeThroughMiddleRing>d__18 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public TargetBallCPU.<BridgeThroughMiddleRing>d__18(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        val_46 = this.middleRingBalls[(long)val_46];
        if(val_46 == 0)
        {
            goto label_14;
        }
        
        val_46 = this.middleRingBalls[this.<j>5__4].gameObject;
        ...
        val_46 = this.middleRingBalls[(long)13 - (this.<j>5__4)];
        if(val_46 == 0)
        {
            goto label_34;
        }
        
        val_46 = this.middleRingBalls[(long)13 - (this.<j>5__4)].gameObject;
        ...
        label_21:
        val_46 = this.middleRingBalls[this.<j>5__4];
        if(val_46 == 0)
        {
            goto label_47;
        }
        ...
        UnityEngine.Vector3 val_22 = this.middleRingBalls[this.<j>5__4].gameObject.transform.position;
        val_48 = val_22.z;
        ...
        UnityEngine.Vector3 val_38 = this.middleRingBalls[(long)13 - (this.<j>5__4)].gameObject.transform.position;
        val_48 = val_38.z;
