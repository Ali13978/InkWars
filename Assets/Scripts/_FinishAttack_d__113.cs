using UnityEngine;
private sealed class LineControllerP2.<FinishAttack>d__113 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public LineControllerP2.<FinishAttack>d__113(int <>1__state)
    {
    ...
    private bool MoveNext()
    {
        ...
        this.<>4__this.animController.PlayAnimation(newAnimName:  11, forceOverride:  false);
