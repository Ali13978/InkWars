using UnityEngine;
public sealed class Model_Events.OnRevengeSuperDelegate : MulticastDelegate
{
    // Methods
    public Model_Events.OnRevengeSuperDelegate(object object, IntPtr method)
    {
        mem[1152921529268201344] = object;
        mem[1152921529268201352] = method;
        mem[1152921529268201328] = method;
    }
    public virtual void Invoke(InkWars.Model.Player playerId, InkWars.Model.BubbleTypes bubbleType, InkWars.Model.RevengeSuperEventState state)
    {
        var val_10;
        var val_11;
        var val_12;
    ...
    public virtual System.IAsyncResult BeginInvoke(InkWars.Model.Player playerId, InkWars.Model.BubbleTypes bubbleType, InkWars.Model.RevengeSuperEventState state, System.AsyncCallback callback, object object)
    {
