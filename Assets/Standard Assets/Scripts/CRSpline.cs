...
private class iTween.CRSpline
{
    ...
    public iTween.CRSpline(UnityEngine.Vector3[] pts)
    {
        ...
        this.pts = val_1;
        System.Array.Copy(sourceArray:  pts, destinationArray:  val_1, length:  pts.Length);
    }
    public UnityEngine.Vector3 Interp(float t)
    {
        float val_2 = ((float)this.pts.Length - 3) * t;
        int val_5 = UnityEngine.Mathf.Min(a:  UnityEngine.Mathf.FloorToInt(f:  val_2), b:  this.pts.Length - 4);
        var val_32 = 12;
